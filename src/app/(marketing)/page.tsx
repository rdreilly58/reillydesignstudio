...
const featuredWork = [
  ...
  { title: "Lucian & Gideon's Coloring Fun", client: "lucianandgideon.com", tag: "App Design", image: "/images/portfolio-3.jpg", href: "/portfolio/lucian-and-gideon" },
];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredWork.map((item) => (
              <Link key={item.title} href={`/portfolio/${item.title.toLowerCase().replace(/\s+/g, "-")}`} className="group relative aspect-[4/3] rounded-2xl overflow-hidden bg-zinc-900 border border-zinc-800 hover:border-zinc-600 transition-all">
